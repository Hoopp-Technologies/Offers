          ...
          <div className="flex gap-y-2 flex-wrap justify-center md:justify-start space-x-2 mb-4 md:mb-0">
            {categories?.map((category) => (
              <span
                ...
                className={cn(
                  "px-4 py-2 rounded-full bg-gray-200 text-gray-700 border border-transparent text-sm cursor-pointer hover:bg-gray-300",
                  category === selectedCategory && "bg-gray-300 border-black"
                )}
              >
                {category}
              </span>
